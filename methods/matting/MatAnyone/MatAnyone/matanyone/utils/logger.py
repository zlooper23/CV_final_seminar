...
class TensorboardLogger:
    ...
    def log_image(self, stage_name, tag, image, it, seg_pass, seg_mat, ann=None, img_pass=False):
        # pass_name = "seg" if seg_pass else "mat"
        if seg_pass:
            if seg_mat:
                pass_name = "seg_mat"
            else:
            ...
            if img_pass:
                ...
                pass_name = "mat"
        image_dir = os.path.join(self.run_dir, f'{stage_name}_{pass_name}_images')
        ...
        if ann is None:
            ...
            image.save(os.path.join(image_dir, f'{tag}_{it}_{ann}.png'))
